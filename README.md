...
| `responsive-loader`  | Can resize images on the fly and create multiple versions of it for a `srcSet`. **Important**: You need to additionally install `sharp` (binary, faster). **NOTE**: now supports WebP | [Link][responsive-loader] |
